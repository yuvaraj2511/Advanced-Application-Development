...
public class MyConstant {
    ...
    // Swagger Info
    public static final String SWAGGER_INFO_TITLE = "MOMENTMAKERS";
    ...
    public static final String SWAGGER_INFO_CONTACT_NAME = "YUVARAJ";
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "yuvaraj25112003@gmail.com";
    public static final String SWAGGER_INFO_CONTACT_URL = "https://momentmakers.com";
